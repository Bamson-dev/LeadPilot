...
export const TRIAL_SEQUENCE_VERSION_V1 = 1;
export const TRIAL_SEQUENCE_MAX_STEP_V1 = 15;

export const V1_TRIAL_STEP_HOURS_FROM_SIGNUP: Record<number, number> = {
  1: 0,
  2: 24,
  3: 48,
  4: 72,
...
export const V1_TRIAL_EMAIL_SUBJECTS: Record<number, string> = {
...
export function getV1TrialEmailBody(step: number): string {
